...
<body>
 ...
 <tr>
 <td style="border:1px solid skyblue;" valign="top" width="250" align="left"><font class="paragraping2"><font color="#006633" size="+1">Browse By</font></font>
...
<% 
 ...
 <td class="paragraping2" width="30%" style="color:white;">Book Type</td>
  <td class="paragraping2" width="10%" style="color:white;">Rank Here</td>
 </tr>
<% 
String bookid = request.getParameter("bookid");
	...
	String sql1="select url.bookid as Book_URL,rank.bookid as Book_Name,category.bookid as Book_Category,type.bookid as Book_Type from url,rank,category,type where type.bookid='"+bookid+"' and type.id=rank.id and type.id=url.id and type.id=category.id";
...
%> 
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Query Name<br><br>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font class="pass"><% out.println(rs1.getString(4));%></font> 
			<br><br>
