...
<% 
 ...
 <td class="paragraping2"  style="color:white;">Complete</td>
  <td class="paragraping2"  style="color:white;">Well-Written</td>
   <td width="168" class="paragraping2"  style="color:white;">Update/Delete</td>
   <td width="153" class="paragraping2"  style="color:white;">Conform Votes</td>
 </tr>
<% 
	   ...
	   con1=databasecon.getconnection();
        ...
        <td width="105"  class="paragraping2"><% out.println(rs1.getString(1));%></td>
		 <td width="106"  class="paragraping2"><% out.println(rs1.getString(3));%></td>
		  ...
		  <td><img src="images/update.jpg">&nbsp;<a href="update.jsp?<% out.println(rs1.getString(1));%>" class="paragraping2">Update</a>&nbsp;|&nbsp;<img src="images/delete.jpg">&nbsp;<a href="delete.jsp?<% out.println(rs1.getString(1));%>" class="paragraping2">Delete</a></td>
<td height="40"  class="paragraping2"><a href="addfavorite.jsp?<% out.println(rs1.getString(1));%>" class="paragraping2">Conform Votes</a></td>
