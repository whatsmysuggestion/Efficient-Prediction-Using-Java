...
<body>
<form name="idpasschbox" method="get" action="reviewdelete.jsp" onsubmit="return validation()">
 <div id="topheader">
 ...
 <tr bgcolor="#910000">
  ...
  <td class="paragraping2"  style="color:white;">College Name</td>
 <td class="paragraping2"  style="color:white;">Address</td>
 <td class="paragraping2"  style="color:white;">Best Friend</td>
 <td class="paragraping2"  style="color:white;">Major Subject </td>
  <td class="paragraping2"  style="color:white;">Language</td>
    <td class="paragraping2"  style="color:white;">Location</td>
	   ...
	   con1=databasecon.getconnection();
        ...
        <td width="83"  class="paragraping2"><% out.println(rs1.getString(2));%></td>
		 <td width="166"  class="paragraping2"><% out.println(rs1.getString(3));%></td>
		  ...
		  <td width="43"  class="paragraping2"><% out.println(rs1.getString(5));%></td>
		    <td width="141"  class="paragraping2"><% out.println(rs1.getString(6));%></td>
			<td width="105"  class="paragraping2"><% out.println(rs1.getString(7));%></td>
	
			<td width="16%"><input type="checkbox" name="checkbox" value="<%=rs1.getString(1)%>"></td> 
