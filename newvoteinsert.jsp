...
<% 
	 ...
	 session.setAttribute("web",request.getParameter("web"));
...
String mess=(String)session.getAttribute("mess");
       ...
       try
        ...
        String sql="insert into newvote values('"+bookid+"','"+user+"','"+category+"','"+type+"','"+web+"','"+trust+"','"+object+"','"+complete+"','"+well+"','"+mess+"','"+hitsCount+"')";
