...
<body>
 ...
 <tr>
 <td height="393">
<form name="testnameform1" method="Post" action="addurl1.jsp">
<table align="center" width="741" height="290" cellpadding="0" background="images/back.jpg">
<tr>
<td height="112" colspan="3" align="center" class="userlogin">Add BookID</td>
</tr>
<tr>
<td width="58"></td>
<td width="188" height="91" class="yellow">Add BookID:</td>
