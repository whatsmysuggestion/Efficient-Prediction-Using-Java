...
<body>
 ...
 <td height="54"><input type="text" name="bookid" style="border:1px solid red;font-family:verdana;font-size:12px;width:200px;padding:5px 5px 5px 5px;"></td>
  ...
  <tr>
            <td height="42"> &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="submit" name="sub2" value="Search" style="border:1px solid green;font-family:verdana;font-size:12px;padding:2px 2px 2px 2px;"></td>
 </tr>
 </form>
 </table>
 <table align="center" width="250">
...
<tr>
<td colspan="4" class="paragraping2">Don't see the Book you are looking for?

Share your opinions on books not covered in this survey. <a href="newvote.jsp" class="paragraping2"><font color="#FF0000">Write in a Vote</font>.</a>
</td>
</tr>
</form>
</table>            
