...
<tr>
<td width="174" height="40" class="paragraping2">User ID:</td>
<td width="301"><input type="text" name="user" size="30" readonly="" value="<% out.println(rs.getString(1));%>" class="paragraping2"></td>
</tr>
<tr>
<td height="43" class="paragraping2">First Name:</td>
<td width="301"><input type="text" name="firstname" size="30" readonly="" value="<% out.println(rs.getString(2));%>" class="paragraping2"></td>
</tr>
<tr>
<td height="41" class="paragraping2">Last Name:</td>
<td width="301"><input type="text" name="lastname"size="30" value="<% out.println(rs.getString(3));%>" class="paragraping2"></td>
</tr>
<tr>
<td height="41" class="paragraping2">Age:</td>
<td width="301"><input type="text" name="age"size="30" value="<% out.println(rs.getString(6));%>" class="paragraping2"></td>
</tr>
<tr>
<td height="43" class="paragraping2">Phone:</td>
<td width="301"><input type="text" name="telephone" size="30"  value="<% out.println(rs.getString(7));%>" class="paragraping2"></td>
</tr>
<tr>
<td height="45" class="paragraping2">Password:</td>
<td width="301"><input type="text" name="password2" size="30" value="<% out.println(rs.getString(8));%>" class="paragraping2"></td>
</tr>
<tr>
<td height="45" class="paragraping2">Email:</td>
<td width="301"><input type="text" name="email2" size="30" value="<% out.println(rs.getString(9));%>" class="paragraping2"></td>
</tr>
<tr>
