...
String bookid = request.getParameter("bookid");
	...
	Statement st1=null;
	ResultSet rs1=null;
	String sql1="select url.bookid as Book_URL,rank.bookid as Book_Name,category.bookid as Book_Category,type.bookid as Book_Type from url,rank,category,type where category.bookid='"+bookid+"' and category.id=rank.id and category.id=url.id and category.id=type.id";
	try
	{
