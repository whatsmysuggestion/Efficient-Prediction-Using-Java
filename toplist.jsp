...
<form id="form1" name="form1" method="post" action="searchengine.jsp">
 <div id="topheader">
   ...
   <div class="search_menu_banner">
	 ...
	 <div class="tick_head"><span class="tick_head1">Top Rank Users</span></div><br><br>
 ...
 <td class="paragraping2"  style="color:white;">Complete</td>
  <td class="paragraping2"  style="color:white;">Well-Written</td>
    <td class="paragraping2"  style="color:white;">Hits of User</td>
	    <td class="paragraping2"  style="color:white;">View User Rank Chart</td>
...
<% 
	...
	Statement st1=null;
	ResultSet rs1=null;
	String sql1="select * from vote where hitsCount > 10";
	try
	{
		...
		while(rs1.next())
	     {
			...
			%>
		<td width="77"  class="paragraping2"><% out.println(rs1.getString(1));%></td>	
        <td width="97"  class="paragraping2"><% out.println(rs1.getString(2));%></td>
		 <td width="139"  class="paragraping2"><% out.println(rs1.getString(3));%></td>
		  <td width="87"  class="paragraping2"><% out.println(rs1.getString(4));%></td>
		  <td width="79"  class="paragraping2"><% out.println(rs1.getString(5));%></td>
		    <td width="99"  class="paragraping2"><% out.println(rs1.getString(6));%></td>
			<td width="94"  class="paragraping2"><% out.println(rs1.getString(8));%></td>
			<td width="138"  class="paragraping2"><a href="chart.jsp" class="paragraping2">Rank Chart</a></td>
